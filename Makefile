...
DEPS := libadwaita-1 gtk4-layer-shell-0 upower-glib wireplumber-0.5 libpipewire-0.3 json-glib-1.0 libnm libpulse libpulse-simple libpulse-mainloop-glib wayland-client wayland-protocols gio-unix-2.0
